...
@section('content')
    ...
    <div class="container post-content">
        ...
        <div class="social">
            ...
            <?php $url = config('app.url')."/".$post->user->name."/".$post->slug; ?>
            ...
            <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text={{$post->title}}&nbsp;|&nbsp;{{$settings->title}}&amp;url={{$url}}" target="_blank" rel="noopener" aria-label="">
            ...
            <a class="resp-sharing-button__link" href="https://pinterest.com/pin/create/button/?url={{$url}}&amp;media={{$url}}&amp;description={{$post->title}}&nbsp;|&nbsp;{{$settings->title}}" target="_blank" rel="noopener" aria-label="">
            ...
            <a class="resp-sharing-button__link" href="mailto:?subject={{$post->title}}&nbsp;|&nbsp;{{$settings->title}}&amp;body={{$url}}" target="_self" rel="noopener" aria-label="">
