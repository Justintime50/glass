...
@section('content')
    ...
    <div class="container">
        ...
        <a class="btn btn-primary bottom-margin-30" href="{{ strtolower(url('/'.$post->user->name.'/'.$post->slug)) }}"><i class="fas fa-chevron-left"></i> Back to Post</a>
        <h1>Edit Post</h1>
        ...
        <input type="text" class="form-control" name="title" id="title" value="{{ old('title', $post->title) }}" oninput="slugifyField('title', 'slug')">
